...
const WisdomTeeth = ({ data }) => {
  ...
  const handleOnSubmit = async (e) => {
    ...
    const email = { ...mail, ...selectedFile }
    data.append('mail', JSON.stringify(mail));
    fetch('/api/emailwithattchment/', {
      method: "POST",
      /* headers: {
                    ...
                    <Grid container spacing={5}>
                      <Grid item xs={12} lg={8}>
                        ...
                        <section className='mt-md-5 mt-4 bg-grey'>
                          <Container maxWidth="xxl" className="p-0">
                            <Box p={2}>
                              <SectionalHeading variant="h5" color="var(--dark-blue)" title="Book an appointment with Carrum Downs Dental (Dandenong-Frankston Rd) on 03-9782 1200 for your wisdom tooth extraction." align="center" />
                            ...
                            <Box p={3}>
                              <form onSubmit={handleOnSubmit}>
                                <div className='form-group'>
                                  <input className='form-control' placeholder='Name' type="text" name="username" onChange={handleOnChange} required />
                                </div>
                                <div className='form-group'>
                                  <input className='form-control' placeholder='Phone Number' type="tel" name="userphone" onChange={handleOnChange} required />
                                </div>
                                <div className='form-group'>
                                  <input className='form-control' placeholder='Email' type="email" name="useremail" onChange={handleOnChange} required />
                                </div>
                                <div className='form-group'>
                                  <input className='form-control' type="file" name="attachment" onChange={(e) => setSelectedFile(e.target.files[0])} />
                                </div>
                                <div className='form-group'>
                                  <textarea className="form-control" name="message" rows="3" spellCheck="false" onChange={handleOnChange} ></textarea>
                                </div>
                                <div className='d-flex justify-content-center align-items-center'>
                                  <button type='submit' className="btn btn-lg blueFilledBtn text-white rounded-pill">Send</button>
                                </div>
                              </form>
                            </Box>
                          </Box>
