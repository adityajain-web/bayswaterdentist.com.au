              ...
              <Grid item xs={12} md={10} className="mx-auto">
                <Box py={2}>
                  <Box>
                    ...
                    <Typography className="para mb-3">It is paramount to brush and floss your teeth daily. However, no matter how you do it, there are some plaque and tartar that must be removed professionally by a dentist. The dentist will use a rotating brush and other dental instruments to clean and polish your teeth. Professional dental cleaning will help you in treating and preventing gum disease. </Typography>
                  </Box>

                  <Box mt={3}>
                    <Typography className='subtitle' variant="h3" gutterBottom align={width > 600 ? 'left' : 'center'}>Dental Check-Ups</Typography>
                    <Typography className="para mb-3">A regular dental check-up is an important part of your oral health. During a dental check-up, your dentist will have an opportunity to ask you about general health as well as medications. In some cases, general health might affect oral health. Also, some medications can affect the health of your mouth.</Typography>
                    <Typography className="para mb-3">Also, during the check-up, your dentist will use some dental instruments to look for issues such as gum disease and tooth decay. The soft tissue of the mouth, such as lips, tongue and palate, will also be examined for signs of oral cancer. Your dentist might also check on the condition of your jaws and lymph nodes. </Typography>
                    <Typography className="para mb-3">One of the major benefits of regular dental check-ups is that the dentist can arrest some dental problems before they become severe. </Typography>
                  </Box>

                  <Box mt={3}>
                    <Typography className='subtitle' variant="h3" gutterBottom align={width > 600 ? 'left' : 'center'}>Dental Emergency</Typography>
                    <Typography className="para mb-3">Dental Emergencies can occur any time of the day or night and ranges from a knocked-out tooth to agonizing toothache. If you encounter such a problem, you will require emergency services immediately to either alleviate the pain or save your tooth. It is vital to understand the difference between a dental situation that can wait until morning and one that requires emergency services. A dental emergency includes knocked out tooth, chipped or broken tooth, lost filling or crown, abscess and bleeding after tooth extraction.</Typography>
                  </Box>
                </Box>
              </Grid>
            </Grid>
            ...
            <Grid container>
              <Grid item xs={12} md={10} className="mx-auto">
                ...
                <PageSectionalHeading title="Bottom Line" variant="h2" align={width > 600 ? 'left' : 'center'} />
                  <Typography className="para mb-3">Visit us at Bayswater Dentist near The Basin for all your dental needs. You will find some friendly faces that will give you a warm welcome. We will also make sure that you are comfortable and enjoy your dental visit. Call us today!</Typography>
                </Box>
              </Grid>
            </Grid>
          </Container>
