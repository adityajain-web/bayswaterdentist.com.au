                  ...
                  <Container maxWidth="xxl">
                    <Box>
                      <Grid container spacing={3}>
                        ...
                        <Grid item xs={12} lg={6}>
                          <Box>
                            <PageSectionalHeading title="How we achieve it:" variant="h3" align="left" />
                            <Box>
                              <List>
                                <ListItem>
                                  <ListItemIcon>
                ...
                <section className='mt-md-4 mt-3'>
                  <Container maxWidth="xxl">
                    <Box>
                      ...
                      <Box>
                        <Typography className='subtitle' variant="h3" gutterBottom>Best dental experience</Typography>
                      ...
                      <Box>
                        <Typography className='subtitle' variant="h3" gutterBottom>Detailed patient consultation</Typography>
                      ...
                      <Box>
                        <Typography className='subtitle' variant="h3" gutterBottom>Providing training and continuous education</Typography>
                      ...
                      <Box>
                        <Typography className='subtitle' variant="h3" gutterBottom>Insurance and payment options</Typography>
                        <List>
                          <ListItem>
                            <ListItemIcon>
                              <CheckCircleOutline style={{ color: "var(--blue)" }} />
                ...
                <section className='mt-md-4 mt-3'>
                  <Container maxWidth="xxl">
                    <Box>
                      ...
                      <Box>
                        <Typography className='subtitle' variant="h3" gutterBottom>Trios 3 Shape dental intraoral scanner</Typography>
                      ...
                      <Box>
                        <Typography className='subtitle' variant="h3" gutterBottom>Intraoral camera</Typography>
                      ...
                      <Box>
                        <Typography className='subtitle' variant="h3" gutterBottom>Digital x-ray</Typography>
                      ...
                      <Box>
                        <Typography className='subtitle' variant="h3" gutterBottom>Soft tissue laser</Typography>
                      ...
                      <Box>
                        <Typography className='subtitle' variant="h3" gutterBottom>Advanced Sterilization techniques</Typography>
                      ...
                      <Box>
                        <Typography className='subtitle' variant="h3" gutterBottom>Amalgam filtration system</Typography>
                      ...
                      <Box>
                        <Typography className='subtitle' variant="h3" gutterBottom>Nitrous oxide for dental patients’ comfort</Typography>
