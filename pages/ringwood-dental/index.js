...
const Ringwood = () => {
  ...
  return (
    <>
      <Head>
        <meta name="description" content="Your smile is an essential part of your personality. Bayswater Dentist near Ringwood offers a wide range of dental services, Don't wait call us today at (03)-9069 3100." />
        <meta name="robots" content="index" />
        <link rel="canonical" href="/ringwood-dental/" />
        <title>Ringwood Community Dental Clinic | Bayswater Dentist</title>
      </Head>
      <CommonHero />
      <main>
        ...
        <section className="mt-md-4 mt-3 bg-light">
          <Container maxWidth="xxl">
            <Grid container>
              <Grid item xs={12} md={10} className="mx-auto">
                <Box py={2}>
                  <PageSectionalHeading title="Some of the Dental Services Offered by Bayswater Dentist near Ringwood" variant="h2" align='center' />
                  <Box mt={3}>
                    <Typography className='subtitle' variant="h3" gutterBottom align={width > 600 ? 'left' : 'center'}>Teeth Whitening</Typography>
                    <Typography className="para mb-3">Teeth whitening procedures help to restore the smiles of people with dull, stained or discoloured teeth. The dentin of your teeth can become exposed when the outer layer of your teeth gets worn out by the effects of ageing or smoking.</Typography>
                  </Box>

                  <Box mt={3}>
                    <Typography className='subtitle' variant="h3" gutterBottom align={width > 600 ? 'left' : 'center'}>Toothaches</Typography>
                    <Typography className="para mb-3">In some rare cases, a toothache can be simply relieved by rinsing off your mouth to clear the debris. However, in many cases, a toothache can result from food remains stuck between the teeth. Avoid taking aspirin to relieve the pain because the dissolving aspirin can actually harm your gums. Always contact your dentist incase you experience any pain.</Typography>
                  </Box>

                  <Box mt={3}>
                    <Typography className='subtitle' variant="h3" gutterBottom align={width > 600 ? 'left' : 'center'}>Tooth Extractions</Typography>
                    <Typography className="para mb-3">Tooth extractions can sound so scary and painful. Truthfully, they are not the most pleasing of procedures. However, our dentist at Bayswater Dentist near Ringwood will do everything in their power to help you feel comfortable and safe. </Typography>
                  </Box>

                  <Box mt={3}>
                    <Typography className='subtitle' variant="h3" gutterBottom align={width > 600 ? 'left' : 'center'}>Dental Fillings</Typography>
                    <Typography className="para mb-3">Tooth cavities are patient&apos;s most common oral issue, and they are too easy to develop. For most tooth decay, a filling is the recommended treatment. Fortunately, filling cavities is a fast and easy procedure. You will be numbed, which mostly lasts for a few hours after the treatment is done. Usually, the entire procedure takes about an hour, and your tooth will be as good as new.</Typography>
                  </Box>

                  <Box mt={3}>
                    <Typography className='subtitle' variant="h3" gutterBottom align={width > 600 ? 'left' : 'center'}>Dentures</Typography>
                    <Typography className="para mb-3">In most instances, dentures are associated with ageing. Nonetheless, a lot of people may need dentures. Dentures are meant to replace one or many missing teeth in a natural way, and they are usually removable. Getting the custom-made dentures may take a bit of time. However, in the end, it is all worth it. </Typography>
                  </Box>
                </Box>
              </Grid>
            </Grid>
