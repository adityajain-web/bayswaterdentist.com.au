...
const Vermont = () => {
  ...
  return (
    <>
      <Head>
        <meta name="description" content="We offer a number of dental services to people of all ages ranging from children to adults. Schedule an online appointment with Bayswater Dentist near Vermont." />
        <meta name="robots" content="index" />
        <link rel="canonical" href="/vermont-dental/" />
        <title>Dentist in Vermont - Dental Care Clinic | Bayswater Dentist</title>
      </Head>
      <CommonHero />
      <main>
              ...
              <Grid item xs={12} md={10} className="mx-auto">
                <Box py={2}>
                  <Box>
                    ...
                    <Typography className="para mb-3">There are a number of reasons why you could be missing a tooth or some teeth. Some of these reasons include dental trauma, tooth decay and gum disease. However, irrespective of the reason you are missing your teeth, replacing them should be your first priority. Dental Implants are a tooth replacement option where the dentist uses a titanium post as the root and a dental crown as the tooth. Your dentist will create a strong and visually appealing replacement that will be hard for anyone to tell that you have installed a dental implant. </Typography>
                  </Box>
                  <Box mt={3}>
                    <Typography className='subtitle' variant="h3" gutterBottom align={width > 600 ? 'left' : 'center'}>Dental Veneers </Typography>
                    <Typography className="para mb-3">Dental veneers are a replacement treatment used to correct chipped, decayed or cracked teeth. They are used to correct only the front teeth. Today, dental veneers are a very popular dental procedure for people looking to brighten their smiles. They are natural looking, durable and simple to apply. Your dentist will show you various shades of brightness and choose the one that best suits you. </Typography>
                  </Box>

                  <Box mt={3}>
                    <Typography className='subtitle' variant="h3" gutterBottom align={width > 600 ? 'left' : 'center'}>Dental Bonding</Typography>
                    <Typography className="para mb-3">Dental bonding is effective for teeth with some small damages that, if not taken care of, can easily lead to extensive damage. It repairs chips, reduces the gap between your teeth or changes the colour or shape of your teeth. The procedure uses tooth-coloured composite resin to improve the appearance of your smile. </Typography>
                  </Box>
                </Box>
              </Grid>
            </Grid>
