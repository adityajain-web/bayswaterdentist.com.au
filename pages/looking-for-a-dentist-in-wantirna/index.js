              ...
              <Grid item xs={12} md={10} className="mx-auto">
                <Box py={2}>
                  ...
                  <Box className="mt-3">
                    ...
                    <Typography className="para mb-3">Teeth whitening is one of the most sort-after dental treatments. Most people are always looking for ways they can make their teeth whiter and smile brighter. However, most over-the-counter whitening methods don&apos;t yield satisfactory results. At Bayswater dentist near Wantirna, we use different whitening methods, including ZOOM and Boutique treatment. </Typography>
                  </Box>

                  <Box className="mt-3">
                    <Typography className='subtitle' variant="h3" gutterBottom align={width > 600 ? 'left' : 'center'}>Dental Fillings</Typography>
                    <Typography className="para mb-3">Dental cavities are quite common and easy to get. If you have a cavity, it is recommended that you use a filling before it advances to tooth decay. The treatment takes less than an hour to complete. During the procedure, you might feel some pressure, but it is not painful at all. </Typography>
                  </Box>

                  <Box className="mt-3">
                    <Typography className='subtitle' variant="h3" gutterBottom align={width > 600 ? 'left' : 'center'}>Dental Crown</Typography>
                    <Typography className="para mb-3">If you have a cavity and it is a little too big for a dental filling, a dental crown can be a perfect answer. You can also use a dental crown if your tooth is decayed to cracked. During the procedure, the dentist will take a mould of your teeth and take it to the lab for crafting. Once the crafting is done, the dentist will come and fit it over the decayed area after cleaning</Typography>
                  </Box>

                  <Box className="mt-3">
                    <Typography className='subtitle' variant="h3" gutterBottom align={width > 600 ? 'left' : 'center'}>Professional Teeth Cleaning</Typography>
                    <Typography className="para mb-3">This is one of the most common reasons why people visit the dentist. It is recommended you visit the dentist for a dental cleaning at least twice a year. It is very vital for your oral health. Your own dental hygiene routine can never be as efficient as the tools used by the dentist to clean. Professional dental cleaning will keep your teeth healthy, strong and bright. </Typography>
                  </Box>
                </Box>
              </Grid>
            </Grid>
