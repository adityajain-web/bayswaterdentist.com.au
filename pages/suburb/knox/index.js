...
const Knox = () => {
  ...
  return (
    <>
      <Head>
        <meta name="description" content="knox" />
        <meta name="robots" content="index" />
        <link rel="canonical" href="/suburb/knox/" />
        <title>Knox</title>
      </Head>
      <CommonHero />
      <main>
            ...
            <Grid container>
              <Grid item xs={12} md={10} className="mx-auto">
                <Box py={2}>
                  ...
                  <Typography className="para">At Bayswater Dentist, we want our patients to feel good about visiting the Dentist. By working with you to understand your unique situation, we can help you to achieve your health and appearance goals. This approach makes sure that you have enjoyed a positive experience and results. </Typography>
                  <Typography className="para">We invite you to visit us today or schedule an appointment with us to see the benefits of being part of the Bayswater Dentist patient family. We believe that the first step towards a healthy and beautiful smile starts with selecting a dentist you can rely upon. </Typography>
                </Box>
              </Grid>
            </Grid>
          </Container>
