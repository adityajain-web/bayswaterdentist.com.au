...
const Kilsyth = () => {
  ...
  return (
    <>
      <Head>
        <meta name="description" content="kilsyth" />
        <meta name="robots" content="index" />
        <link rel="canonical" href="/suburb/kilsyth/" />
        <title>kilsyth</title>
      </Head>
      <CommonHero />
      <main>
            ...
            <Grid container>
              <Grid item xs={12} md={10} className="mx-auto">
                <Box py={2}>
                  ...
                  <Typography className="para">At Bayswater Dentist near Kilsyth, we have a great team who can answer all your questions as well as respond to your needs. Not to mention our clean and organised, both adult and child-friendly clinic with a cosy ambience to make our patients comfortable. </Typography>
                  <Typography className="para">Contact us today and learn more about the latest in cosmetic and general dentistry in Australia</Typography>
                </Box>
              </Grid>
            </Grid>
          </Container>
