...
const Wantirna = () => {
  ...
  return (
    <>
      <Head>
        <meta name="description" content="wantirna" />
        <meta name="robots" content="index" />
        <link rel="canonical" href="/suburb/wantirna/" />
        <title>wantirna</title>
      </Head>
      <CommonHero />
      <main>
        ...
        <section className="mt-md-4 mt-3 bg-light">
          <Container maxWidth="xxl">
            <Grid container>
              <Grid item xs={12} md={10} className="mx-auto">
                <Box py={2}>
                  <PageSectionalHeading title="Dental Service Offered at Bayswater Dentist near Wantirna" variant="h2" align="center" />
                  <Box className="mt-3">
