    ...
    <>
      <Container maxWidth="xxl" className={Styles.hero}>
        <Grid container style={{ height: "inherit" }}>
          <Grid item xs={11} md={10} className="mx-auto d-flex align-items-center" style={{ height: "inherit" }}>
            <Box id="heroText">
              <Typography variant="h1" className={`${Styles.h1} mb-4`}><span className={Styles.span1}>Family Dentist at</span> <br/><span className={Styles.span2}>Bayswater</span></Typography>
